        ...
        <div class="row">
          <div class="col-12">
                        ...
                        <div class="card card-primary">
                          ...
                          <form action="{{ route('nodin.update', $nodin->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="alamat" class="form-control" value="{{$nodin->alamat}}" required>
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="perihal" class="form-control" value="{{$nodin->perihal}}" required>
                      </div>
