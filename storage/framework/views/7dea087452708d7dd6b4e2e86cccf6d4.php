          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                  <a href="<?php echo e(Route('suratmasuk.create')); ?>" class="btn btn-primary float-sm-right"><i class="fas fa-plus-circle"></i> Tambah Surat Masuk</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <tr class="text-center">
                      ...
                      <td class="text-center"><?php if($row->surat): ?>
                        <a href="<?php echo e(route('suratmasuk.surat', $row->id)); ?>" class="btn btn-outline-success btn-sm">
                            <i class="far fa-file-pdf"></i></i> Surat
                        </a>
                        <?php endif; ?>
                            <a href="<?php echo e(route('disposisi.index', $row->id)); ?>" class="btn btn-outline-primary btn-sm">
                                <i class="far fa-copy"></i> Disposisi
                            </a>
                        <a href="<?php echo e(route('suratmasuk.edit', $row->id)); ?>" class="btn btn-outline-danger btn-sm"><i class="fas fa-edit"></i> Edit</a>
                      </td>
...
<?php endif; ?><?php /**PATH D:\Kuliah\Magang\Web\Web Fix\DIAPRA\resources\views/suratmasuk/index.blade.php ENDPATH**/ ?>