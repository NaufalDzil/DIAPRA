...
<div class="disposisi-container">
    <div class="header">
        <img src="<?php echo e(asset('AdminLTE/docs/assets/img/logo.png')); ?>" alt="Logo"> 
    ...
    <div class="content-section">
        <label>Surat dari :</label> <input style="width: 80%;" value="<?php echo e($suratmasuk->alamat); ?>" readonly ></input>
        <label>Nomor Surat :</label> <input style="width: 80%;" value="<?php echo e($suratmasuk->nomor_surat); ?>" readonly ></input>
        <label>Tanggal Surat:</label> <input style="width: 80%;" value="<?php echo e(\Carbon\Carbon::parse($suratmasuk->tanggal_surat)->translatedFormat('d-m-Y')); ?>" readonly ></input>
        <label>Nomor Agenda:</label> <input style="width: 80%;" value="<?php echo e($suratmasuk->id); ?>" readonly></input><br>
        <label>Sifat:</label> 
        ...
        <label style="vertical-align: top;">Perihal:<br></label> <textarea readonly><?php echo e($suratmasuk->perihal); ?></textarea>
    </div>
    ...
    <div class="signature-section">
        ...
        <br><br><br>
        <p><?php echo e($kadis->nama); ?>

            <br><?php echo e($kadis->pangkat); ?>

        <br>NIP. <?php echo e($kadis->NIP); ?></p>
    </div>
</div>
</div>
...
<?php /**PATH D:\Kuliah\Magang\Web\Web Fix\DIAPRA\resources\views\disposisi\disposisi.blade.php ENDPATH**/ ?>