        ...
        <div class="row">
          <div class="col-12">
                        ...
                        <div class="card card-primary">
                          <!-- /.card-header -->
                          <!-- form start -->
                          <form action="<?php echo e(route('spj.store')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="card-body">
...
<?php endif; ?><?php /**PATH D:\Kuliah\Magang\Web\Web Fix\DIAPRA\resources\views\spj\create.blade.php ENDPATH**/ ?>