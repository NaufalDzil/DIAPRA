                        ...
                        <div class="card card-primary">
                          ...
                          <form action="<?php echo e(route('suratmasuk.update', $suratmasuk->id)); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="alamat" class="form-control" value="<?php echo e($suratmasuk->alamat); ?>" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nomor_surat" class="form-control" value="<?php echo e($suratmasuk->nomor_surat); ?>" required>
                            </div>
                            
                            <div class="form-group">
                              <label>Perihal : <b class="text-danger">*</b></label>
                              <input type="text" name="perihal" class="form-control" value="<?php echo e($suratmasuk->perihal); ?>" required>
                          </div>
...
<?php endif; ?><?php /**PATH D:\Kuliah\Magang\Web\Web Fix\DIAPRA\resources\views\suratmasuk\edit.blade.php ENDPATH**/ ?>