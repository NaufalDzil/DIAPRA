                        ...
                        <div class="card card-primary">
                          ...
                          <form action="<?php echo e(route('spj.update', $spj->id)); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="nama_kegiatan" class="form-control" value="<?php echo e($spj->nama_kegiatan); ?>" required>
                          </div>
...
<?php endif; ?><?php /**PATH D:\Kuliah\Magang\Web\Web Fix\DIAPRA\resources\views\spj\edit.blade.php ENDPATH**/ ?>