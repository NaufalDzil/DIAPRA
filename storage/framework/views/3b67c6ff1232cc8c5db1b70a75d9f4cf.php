        ...
        <div class="row">
          <div class="col-12">
                        ...
                        <div class="card card-primary">
                          <!-- /.card-header -->
                          <!-- form start -->
                          <form action="<?php echo e(route('st.store')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="card-body">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="lamanya" class="form-control" placeholder="Lamanya" required>
                            </div>
...
<?php endif; ?><?php /**PATH D:\Kuliah\Magang\Web\Web Fix\DIAPRA\resources\views\st\create.blade.php ENDPATH**/ ?>